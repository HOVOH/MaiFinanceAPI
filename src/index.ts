...
import {
  ...
  QI__factory,
  Vault__factory,
} from './bindings/factories';

const vault = (address: string, deployedAt: number) =>
  new ContractVersions(Vault__factory.connect, [
    {
      address,
      deployedAt,
    },
