...
export interface MAIInterface extends utils.Interface {
  functions: {
...
export interface LogAddAuthEventObject {
  auth: string;
  timestamp: BigNumber;
}
export type LogAddAuthEvent = TypedEvent<
  [string, BigNumber],
  LogAddAuthEventObject
>;
...
export interface MAI extends BaseContract {
